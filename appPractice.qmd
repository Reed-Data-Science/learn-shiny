...
For each of these problems, I have given you some static code as a starting point.  Take this code and then follow the workflow we discussed in-class on Monday.

1. Create the app folder and an app.r script file.
2. Iterate between editing, running, and experimenting with the app.

Here's some template code to get you started on each app.  
